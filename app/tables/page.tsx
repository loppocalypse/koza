  ...
  return (
    <div className="min-h-screen flex flex-col bg-brand-beige selection:bg-brand-gold selection:text-white">
      ...
      <header className="relative h-[70vh] flex items-center justify-center overflow-hidden bg-brand-ink">
        ...
        >
          <img
            src="/rattan_siesta.jpg"
            alt="Artisan Dining & Banquet Tables"
        ...
        <div className="container mx-auto px-6 relative z-10 text-center text-white">
          ...
          >
            <span className="text-[10px] uppercase tracking-[0.5em] font-medium mb-6 block text-brand-gold">
              Dining & Banquet Architecture
            </span>
            <h1 className="text-6xl md:text-8xl font-display leading-[0.9] tracking-tighter">
              Tables & <br /> <span className="italic font-normal">Surfaces</span>
            </h1>
          </motion.div>
        </div>
      ...
      <div className="relative z-20 -mt-16">
        <ProductExplorer searchQuery={searchQuery} category="Tables" />
      </div>
